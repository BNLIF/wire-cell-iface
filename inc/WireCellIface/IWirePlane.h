/**
   Provides information about one wire plane in terms of its wire
   direction, pitch, impact response, bounding box and individual
   wires from which channel information can be derived.
...
namespace WireCell {
    ...
    public:
        ...
        virtual const PlaneImpactResponse* pir() const = 0;
